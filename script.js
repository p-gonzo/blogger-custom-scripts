...
(() => {
    setTimeout( () => {
        ...
        const myFunction = (x) => {
          if (x.matches) {
              document.getElementsByClassName("post-body entry-content")[0].style.fontSize = '18px';
              document.getElementsByClassName('main_header_elements container')[0].style.overflowY = 'hidden';
          } else {
              document.getElementsByClassName("post-body entry-content")[0].style.fontSize = '20px';
            }
        }
